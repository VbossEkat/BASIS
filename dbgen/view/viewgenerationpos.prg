...
SELECT ;
	...
	CAST(CASE ;
            ...
            WHEN POSFuncInSet.POSLinkObjTypeID = 7 THEN 'MATRIX' ;
	...
	CAST(CASE ;
            ...
            WHEN POSFuncInSet.POSLinkObjTypeID = 7 THEN ISNULL(Tovar.TvrID,000000) ;
	...
	CAST(CASE ;
            ...
            WHEN POSFuncInSet.POSLinkObjTypeID = 7 THEN ISNULL(Tovar.TvrNM,'') ;
	...
	CAST(CASE WHEN POSFuncInSetLinkObj <> 0 THEN 1 ELSE 0 END AS bit) AS IsLinked , POSKeyCode ;
FROM POSFuncInSet ;
