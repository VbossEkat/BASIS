...
#DEFINE    pcvCONNECTIONNAME    SQLBASISCONNECTION
***
***SELECT  CheckTrans.CheckTransUID,  ;
...
CREATE SQL VIEW lvCheckTransView REMOTE CONNECTION 'SQLBASISCONNECTION' SHARE AS ;
SELECT ;
...
***
DBSETPROP([lvCheckTransView],[VIEW],[COMMENT],[LV CASH: Транзакции чека (viewgenerationstorage.prg)])
***
ENDPROC
*------------------------------------------------------------------------------
